...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "transition-all duration-[280ms] ease-[cubic-bezier(0.22,1,0.36,1)] delay-[30ms]",
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ...
    className={cn(
      ...
      "data-[state=active]:animate-in data-[state=active]:fade-in-0 data-[state=active]:slide-in-from-right-[2px]",
      "data-[state=inactive]:animate-out data-[state=inactive]:fade-out-0 data-[state=inactive]:slide-out-to-left-[2px]",
      "data-[state=active]:duration-[260ms] data-[state=inactive]:duration-[180ms]",
      "data-[state=active]:ease-[cubic-bezier(0.22,1,0.36,1)] data-[state=inactive]:ease-out",
